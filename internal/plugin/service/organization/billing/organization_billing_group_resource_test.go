...
func TestAccAivenOrganizationBillingGroup(t *testing.T) {
	...
	config := templBuilder().
		...
		AddResource("aiven_organization_billing_group", map[string]any{
			...
			"payment_method_id":      "3a98e90d-6705-4e39-823d-549c77200eb8",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// Check payment method ID is correctly set
					resource.TestCheckResourceAttrPair(name, "payment_method_id", "aiven_organization_billing_group", "payment_method_id"),
					// Check email lists
