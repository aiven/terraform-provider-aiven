...
type tfModel struct {
	...
	AivenAwsObjectStorageCredentialsCreatorArn types.String `tfsdk:"aiven_aws_object_storage_credentials_creator_arn"`
	AivenManagementCidrBlocks                  types.Set    `tfsdk:"aiven_management_cidr_blocks"`
	AivenObjectStorageCredentialsCreatorUser   types.String `tfsdk:"aiven_object_storage_credentials_creator_user"`
	...
	AwsSubnetsBastion                          types.Map    `tfsdk:"aws_subnets_bastion"`
	AwsSubnetsWorkload                         types.Map    `tfsdk:"aws_subnets_workload"`
...
type apiModel struct {
	...
	AivenAwsObjectStorageCredentialsCreatorArn *string                   `json:"aiven_aws_object_storage_credentials_creator_arn,omitempty"`
	AivenManagementCidrBlocks                  *[]string                 `json:"aiven_management_cidr_blocks,omitempty"`
	AivenObjectStorageCredentialsCreatorUser   *string                   `json:"aiven_object_storage_credentials_creator_user,omitempty"`
	...
	AwsSubnetsBastion                          *map[string]*string       `json:"aws_subnets_bastion,omitempty"`
	AwsSubnetsWorkload                         *map[string]*string       `json:"aws_subnets_workload,omitempty"`
...
func expandData[R any](ctx context.Context, plan, state *tfModel, req *R, modifiers ...util.MapModifier[tfModel]) diag.Diagnostics {
	...
	if !plan.Tags.IsNull() || state != nil && !state.Tags.IsNull() {
		vTags := make(map[string]*string, 0)
		diags := plan.Tags.ElementsAs(ctx, &vTags, false)
		if diags.HasError() {
			return diags
		}
		api.Tags = &vTags
...
func flattenData[R any](ctx context.Context, state *tfModel, rsp *R, modifiers ...util.MapModifier[tfModel]) diag.Diagnostics {
	...
	if api.AivenManagementCidrBlocks != nil || state.AivenManagementCidrBlocks.IsUnknown() || state.AivenManagementCidrBlocks.IsNull() {
	...
	if api.AwsSubnetsBastion != nil || state.AwsSubnetsBastion.IsUnknown() || state.AwsSubnetsBastion.IsNull() {
		vAwsSubnetsBastion, diags := util.MapValueFrom(ctx, types.StringType, api.AwsSubnetsBastion)
		if diags.HasError() {
			return diags
		}
		state.AwsSubnetsBastion = vAwsSubnetsBastion
	}
	if api.AwsSubnetsWorkload != nil || state.AwsSubnetsWorkload.IsUnknown() || state.AwsSubnetsWorkload.IsNull() {
		vAwsSubnetsWorkload, diags := util.MapValueFrom(ctx, types.StringType, api.AwsSubnetsWorkload)
		if diags.HasError() {
			return diags
		}
		state.AwsSubnetsWorkload = vAwsSubnetsWorkload
	}
	if api.BucketNames != nil || state.BucketNames.IsUnknown() || state.BucketNames.IsNull() {
	...
	if api.ContactEmails != nil && !state.ContactEmails.IsUnknown() {
	...
	if api.CustomCloudNames != nil || state.CustomCloudNames.IsUnknown() || state.CustomCloudNames.IsNull() {
	...
	if api.CustomTags != nil || state.CustomTags.IsUnknown() || state.CustomTags.IsNull() {
	...
	if api.Errors != nil || state.Errors.IsUnknown() || state.Errors.IsNull() {
	...
	if api.Tags != nil && !state.Tags.IsUnknown() {
		vTags, diags := util.MapValueFrom(ctx, types.StringType, api.Tags)
		if diags.HasError() {
			return diags
		}
		state.Tags = vTags
	...
	if api.AivenAwsObjectStorageCredentialsCreatorArn != nil || state.AivenAwsObjectStorageCredentialsCreatorArn.IsUnknown() {
		state.AivenAwsObjectStorageCredentialsCreatorArn = util.StringPointerValue(api.AivenAwsObjectStorageCredentialsCreatorArn)
	}
	if api.AivenObjectStorageCredentialsCreatorUser != nil || state.AivenObjectStorageCredentialsCreatorUser.IsUnknown() {
		state.AivenObjectStorageCredentialsCreatorUser = util.StringPointerValue(api.AivenObjectStorageCredentialsCreatorUser)
	}
...
func flattenErrors(ctx context.Context, api *apiModelErrors) (*tfModelErrors, diag.Diagnostics) {
	...
	if api.Category != nil || state.Category.IsUnknown() {
		state.Category = util.StringPointerValue(api.Category)
	}
	if api.Message != nil || state.Message.IsUnknown() {
