...
func (r *externalIdentityDataSource) Schema(
	...
	resp.Schema = schema.Schema{
		Description: userconfig.Desc("Links external usernames to Aiven users, ensuring that requesters and approvers are correctly identified for [Aiven for Apache Kafka® Governance approval workflows](https://aiven.io/docs/products/kafka/howto/terraform-governance-approvals).").Beta().Build(),
