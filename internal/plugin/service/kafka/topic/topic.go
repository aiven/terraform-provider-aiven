...
// - During `apply`, the response was not read. See 1).
...
// While technically a breaking change, this provides a more consistent user experience by eliminating state drift.
//
