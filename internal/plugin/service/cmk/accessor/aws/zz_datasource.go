	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"principal": schema.StringAttribute{
				Computed:            true,
				MarkdownDescription: "The AWS IAM principal ARN that Aiven uses to access your KMS key.",
			},
		...
		MarkdownDescription: "Gets the AWS CMK accessor for an Aiven project. The accessor is used to authenticate Aiven to your AWS Key Management Service (KMS).",
	}
}
