...
func TestAccAivenMySQLDatabase_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccMySQLDatabaseResource(projectName, rName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAivenMySQLDatabaseAttributes("data.aiven_mysql_database.database"),
			...
			{
				Config:                    testAccMySQLDatabaseTerminationProtectionResource(projectName, rName2),
