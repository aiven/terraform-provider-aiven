...
func datadogUserConfig() *schema.Schema {
	return &schema.Schema{
		...
		Elem: &schema.Resource{Schema: map[string]*schema.Schema{
			...
			"site": {
				Description:  "Enum: `ap1.datadoghq.com`, `ap2.datadoghq.com`, `datadoghq.com`, `datadoghq.eu`, `ddog-gov.com`, `us2.ddog-gov.com`, `us3.datadoghq.com`, `us5.datadoghq.com`. Datadog intake site. Defaults to datadoghq.com.",
				Optional:     true,
				Type:         schema.TypeString,
				ValidateFunc: validation.StringInSlice([]string{"ap1.datadoghq.com", "ap2.datadoghq.com", "datadoghq.com", "datadoghq.eu", "ddog-gov.com", "us2.ddog-gov.com", "us3.datadoghq.com", "us5.datadoghq.com"}, false),
			},
		}},
		MaxItems: 1,
		Optional: true,
