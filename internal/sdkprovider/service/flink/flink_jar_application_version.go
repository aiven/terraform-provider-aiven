...
func ResourceFlinkJarApplicationVersion() *schema.Resource {
	...
	s["source"] = &schema.Schema{
		...
		// Terraform required this to be set to true.
...
func flinkJarApplicationVersionCreate(ctx context.Context, d *schema.ResourceData, client avngen.Client) error {
	...
	err = uploadFile(ctx, sourcePath, sourceChecksum, *rsp.FileInfo.Url)
	if err != nil {
...
func uploadFile(ctx context.Context, sourcePath, sourceChecksum, urlPath string) error {
