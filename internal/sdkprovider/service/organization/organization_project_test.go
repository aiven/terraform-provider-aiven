		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config: templBuilder().
					...
					AddDataSource(aivenOrganizationProjectResource, map[string]any{
						"resource_name":   "foo",
						"project_id":      template.Reference("aiven_organization_project.foo.project_id"),
						"organization_id": template.Reference("aiven_organization_project.foo.organization_id"),
					}).MustRender(t),
				Check: resource.ComposeTestCheckFunc(
