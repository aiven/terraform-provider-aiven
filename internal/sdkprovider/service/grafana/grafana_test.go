...
// TestAccAiven_grafana_project_vpc_can_be_removed tests that `project_vpc_id` can be removed from a service.
// https://github.com/aiven/terraform-provider-aiven/issues/2242
func TestAccAiven_grafana_project_vpc_can_be_removed(t *testing.T) {
	ctx := context.Background()
	project := acc.ProjectName()
