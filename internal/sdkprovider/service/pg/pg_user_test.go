...
func TestAccAivenPGUser(t *testing.T) {
	resourceName := "aiven_pg_user.foo.0" // checking the first user only
	singleUserResourceName := "aiven_pg_user.single"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				// bulk creation with optional password
			...
			},
			{
				...
				Config: testAccPGUserSingleAutoGenerated(projectName, serviceName, rName),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
					resource.TestCheckResourceAttr(singleUserResourceName, "username", fmt.Sprintf("single-%s", rName)),

					// Password - auto-generated
					resource.TestCheckResourceAttrSet(singleUserResourceName, "password"),
					resource.TestCheckNoResourceAttr(singleUserResourceName, "password_wo"),
					resource.TestCheckNoResourceAttr(singleUserResourceName, "password_wo_version"),
				),
			},
			{
				// single user transition to optional password
				Config: testAccPGUserSingleOptional(projectName, serviceName, rName, "Optional$Pass123"),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
					...
					// Password - transition to optional
					resource.TestCheckResourceAttr(singleUserResourceName, "password", "Optional$Pass123"),
					resource.TestCheckNoResourceAttr(singleUserResourceName, "password_wo"),
					resource.TestCheckNoResourceAttr(singleUserResourceName, "password_wo_version"),
				),
			},
			{
				// single user transition to write-only password
				Config: testAccPGUserSingleWriteOnly(projectName, serviceName, rName, 1),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
					...
					resource.TestCheckResourceAttr(singleUserResourceName, "password", ""),
					resource.TestCheckResourceAttr(singleUserResourceName, "password_wo_version", "1"),
				),
			},
			{
				// single user rotate write-only password
				Config: testAccPGUserSingleWriteOnly(projectName, serviceName, rName, 2),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
					...
					resource.TestCheckResourceAttr(singleUserResourceName, "password", ""),
					resource.TestCheckResourceAttr(singleUserResourceName, "password_wo_version", "2"),
				),
			},
			{
				// single user transition back to auto-generated
				Config: testAccPGUserSingleAutoGenerated(projectName, serviceName, rName),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					...
					resource.TestCheckResourceAttrSet(singleUserResourceName, "password"),
					resource.TestCheckNoResourceAttr(singleUserResourceName, "password_wo"),
					resource.TestCheckResourceAttr(singleUserResourceName, "password_wo_version", "0"),
				),
			},
			{
				// single user back to optional password
				Config: testAccPGUserSingleOptional(projectName, serviceName, rName, "FinalPass$456"),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
					...
					resource.TestCheckResourceAttr(singleUserResourceName, "password", "FinalPass$456"),
					resource.TestCheckNoResourceAttr(singleUserResourceName, "password_wo"),
					resource.TestCheckResourceAttr(singleUserResourceName, "password_wo_version", "0"),
				),
			},
...
func testAccPGUserSingleAutoGenerated(projectName, serviceName, rName string) string {
	return fmt.Sprintf(`
data "aiven_project" "foo" {
  project = %[1]q
}
...
func testAccPGUserSingleOptional(projectName, serviceName, rName, password string) string {
	return fmt.Sprintf(`
data "aiven_project" "foo" {
  project = %[1]q
}
...
data "aiven_pg_user" "user" {
  ...
  depends_on = [aiven_pg_user.foo]
}`, projectName, serviceName, rName, password)
}

func testAccPGUserSingleWriteOnly(projectName, serviceName, rName string, version int) string {
	return fmt.Sprintf(`
data "aiven_project" "foo" {
  project = %[1]q
}
...
data "aiven_pg_user" "user" {
  ...
  depends_on = [aiven_pg_user.foo]
}`, projectName, serviceName, rName, version)
}
