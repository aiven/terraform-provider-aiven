...
func TestAccAivenPGUser(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				// bulk creation with custom password
				Config: testAccPGUserNewPasswordResource(projectName, serviceName, "acc-custom-P4$$word"),
			...
			},
			{
				...
				Config: testAccPGUserSingleAutoGenerated(projectName, serviceName, userName),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
			...
			{
				// single user transition to custom password
				Config: testAccPGUserSingleOptional(projectName, serviceName, userName, "acc-custom-Optional$Pass123"),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
			...
			},
			{
				...
				Config: testAccPGUserSingleWriteOnly(projectName, serviceName, userName, 1),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
			...
			},
			{
				...
				Config: testAccPGUserSingleWriteOnly(projectName, serviceName, userName, 2),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
			...
			{
				// single user back to custom password
				Config: testAccPGUserSingleOptional(projectName, serviceName, userName, "acc-custom-FinalPass$456"),
				Check: resource.ComposeTestCheckFunc(
					// Basic attributes
					resource.TestCheckResourceAttr(singleUserResourceName, "service_name", serviceName),
					resource.TestCheckResourceAttr(singleUserResourceName, "project", projectName),
...
func testAccPGUserSingleAutoGenerated(projectName, serviceName, userName string) string {
	return fmt.Sprintf(`
data "aiven_project" "foo" {
  project = %[1]q
}
...
func testAccPGUserSingleOptional(projectName, serviceName, userName, password string) string {
	return fmt.Sprintf(`
data "aiven_project" "foo" {
  project = %[1]q
}
...
func testAccPGUserSingleWriteOnly(projectName, serviceName, userName string, version int) string {
	return fmt.Sprintf(`
data "aiven_project" "foo" {
  project = %[1]q
}
