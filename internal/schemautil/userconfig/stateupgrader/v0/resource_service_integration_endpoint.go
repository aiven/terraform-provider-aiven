...
func ResourceServiceIntegrationEndpointResourceV0() *schema.Resource {
...
func ResourceServiceIntegrationEndpointStateUpgradeV0(
	_ context.Context,
	...
	err = rsyslogStateUpgradeV0(rawState)
	if err != nil {
		return rawState, err
	}

	err = externalElasticsearchLogsStateUpgradeV0(rawState)
	if err != nil {
		return rawState, err
	}

	err = externalOpensearchLogsStateUpgradeV0(rawState)
	if err != nil {
		return rawState, err
	}
...
func rsyslogStateUpgradeV0(rawState map[string]interface{}) error {
...
func externalElasticsearchLogsStateUpgradeV0(rawState map[string]interface{}) error {
...
func externalOpensearchLogsStateUpgradeV0(rawState map[string]interface{}) error {
