...
3. Replace the placeholders for `ORGANIZATION_NAME`. It's recommended to use your organization name as a prefix for the project name.

4. Replace the `USER_EMAIL` placeholders in the `get-started.tf` file to make one user an organization admin and add another user to the user group.
