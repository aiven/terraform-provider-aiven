...
- **m3aggregator_user_config** (List of Object) M3 aggregator specific user configurable settings (see [below for nested schema](#nestedatt--m3aggregator_user_config))
