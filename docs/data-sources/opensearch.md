...
- `ml_commons_connector_access_control_enabled` (Boolean)
- `ml_commons_max_model_on_node` (Number)
- `ml_commons_model_access_control_enabled` (Boolean)
- `ml_commons_model_auto_deploy_enable` (Boolean)
- `ml_commons_model_auto_redeploy_enable` (Boolean)
- `ml_commons_native_memory_threshold` (Number)
- `ml_commons_only_run_on_ml_node` (Boolean)
- `ml_commons_trusted_connector_endpoints_regex` (List of String)
