...
- `karapace_version` (String) Enum: `6.2.1`, `6.2.2`, and newer. Select a Karapace version for this service, or select Latest to use the latest available version automatically. New versions become available after installation during a maintenance update.
