...
- **m3aggregator_user_config** (Block List, Max: 1) M3 aggregator specific user configurable settings (see [below for nested schema](#nestedblock--m3aggregator_user_config))
