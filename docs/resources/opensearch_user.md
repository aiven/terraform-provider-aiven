...
- `username` (String) Account username. Maximum length: `64`. Changing this property forces recreation of the resource.
...
- `password_wo_version` (Number) Version number for `password_wo`. Increment this to rotate the password. Must be >= 1. The field is required with `password_wo`. Minimum value: `1`.
