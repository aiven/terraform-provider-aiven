...
- `parent_id` (String) Link a project to an [organization or organizational unit](https://aiven.io/docs/platform/concepts/orgs-units-projects) by using its account ID. To set up proper dependencies please refer to this variable as a reference.
