...
- `disk_space` (String) Service disk space. Possible values depend on the service type, the cloud provider and the project.
...
- `disk_space_used` (String, Deprecated) Read-only version of `disk_space` field.
