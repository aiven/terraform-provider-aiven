...
// This file was generated at Wed Apr 21 10:46:31 CEST 2021
...
var (
  ...
  "datadog": {
    ...
    "properties": {
      ...
      "datadog_tags": {
        "example": "[{'tag': 'foo'}, {'tag': 'bar:buzz', 'comment': 'Useful tag']",
        "items": {
          "properties": {
            "comment": {
  ...
  "prometheus": {
    ...
    "properties": {
      ...
      "basic_auth_username": {
        ...
        "type": "string",
        "user_error": "Must only contain a-z, 0-9, @, _ and -. Also must be 5-32 in lenght"
      }
    },
    "type": "object"
  },
